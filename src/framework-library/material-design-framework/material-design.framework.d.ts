...
export declare class MaterialDesignFramework extends Framework {
    ...
    widgets: {
        ...
        'datetime': typeof MaterialDatetimepickerComponent;
        ...
        'color': typeof MaterialSelectColorComponent;
        ...
        'ckeditor': typeof MaterialCkeditorComponent;
        'icon': typeof MaterialSelectIconComponent;
        'alt-date': string;
        'any-of': string;
        'card': string;
